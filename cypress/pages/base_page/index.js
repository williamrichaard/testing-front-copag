export default class Base {
    ...
    static validateElementText(element, value, index = undefined) {
        this.getElementText(element, index)
            .then((text) => {
    ...
    static clickOnElementInsideModal(element, btnInsideOfModal) {
        this.getElement(element)
            .should('be.visible')
            .then(() => {
                this.clickOnElement(btnInsideOfModal);
            })
    }
    ...
    static verifyIfElementNotExists(element) {
